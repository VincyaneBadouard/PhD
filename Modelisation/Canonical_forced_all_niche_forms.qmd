...
**Objectives:**
Check if the canonical form of the quadratic equation permit to fit different form of light spceies niche (concave, convex, positive or negative linear, flat), when the model force a concave form of probabilities predictions.    
...
```
-> **1075 divergent transitions** after warmup.   
...
-> sigmoid: *a* medians are underestimated but weel <0 as asked by the model.   
