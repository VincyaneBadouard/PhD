...
PATH <- "//amap-data.cirad.fr/work/users/VincyaneBadouard/Modelisation/Plots/Light_topo_onto/1-3/Autocor/First10sp"
```
...
ggplot(databp, aes(x=Incertitude, y= a_median)) +
  ...
  labs(x='*O* 50% incertitude (transmittance %)', y= '*a* median') +
  theme(axis.title = ggtext::element_markdown(),
        legend.title = ggtext::element_markdown())
