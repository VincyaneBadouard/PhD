...
```{r, include=F}
rm(dataM, M_linear,M_Quadra_forced, M_Quadra_free, fits, opts, pb, cores, files, i, j,S, progress); gc()
```
...
-> linear model is better for convex form. Quadradic forced is the worse model for convex.
