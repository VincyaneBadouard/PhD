---
title: "Canonical_forced_+bounds_all_niche_forms"
date: "`r Sys.Date()`"
format: html
self-contained: true
theme: cosmo
...
- a [0, -300]  
  ...
  -0.02 ->  
- O [-7, 0.5]  
- gamma [-3, 200]  (-2 ça fait des divergences sur le no effect et les sigmoides)
...
```{r, fit}
# convex <- sampling(M_Quadra_can, data = dataM[["convexbell"]], chains = 4, cores = 4, iter = 2000)
