...
ggplot(databp) +
  ...
  geom_point(aes(x= tau_median, y = O_median, col=Tau_effect)) + # median
...
```{r}
# light noeffect :
# Iryanthera_sagotiana (O imprécis, a = 0 précis)
# Symphonia_sp.1 (O imprécis, a = 0 précis)
# Inga_loubryana
# Virola_michelii idem
# Pouteria_guianensis idem
# Eschweilera_congestiflora idem
# Couratari_multiflora idem
# Tachigali_melinonii
# Pouteria_gonggrijpii
# Thyrsodium_puberulum
...
ggplot(databp) +
  ...
  geom_point(aes(x= a_median, y = O_median)) + # median
