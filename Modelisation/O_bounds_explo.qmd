...
To have a reasonable quadratic optimum for the sigmoid case, we want to bound "O", for that we need to explore what are a and gamma values to visualize the curve on then environment bounds.  
...
tidyr::crossing(
  a = c(-0.001, -0.02, -0.05, -0.1, -0.25, -0.5, -1, -5, -10, -1000000000000000), #c(-10, -25, -50, -100),
  O = -6, #c(-6, -3, -1),
  gamma = c(-3, -1, 1, 5, 10, 15, 400, 480, 490, 495, 10000000000000000),
  Environment = (seq(-6,1, length.out =50)) # 0.001
) %>% 
...
Ola courbe est plate si gamma < (-3)
voir les proportions nécessaires pour que a et gamma donne du plat dans la case en haut à droite
