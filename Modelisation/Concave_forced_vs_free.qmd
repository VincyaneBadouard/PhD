...
**Objectives:**
We model a species light temperament with a quadratic equation in the developed form, and we want to compare a model forced to a concave form of the presence probabilites estimated, vs a free model, on a simulated linear, convex or flat species niche.
