...
RU <- read_delim("~/PhD/Pédologie/Data/Raw/RU.csv",
                 delim = ";", escape_double = FALSE, trim_ws = TRUE)[,-(20:37)]

Bulk_density <- read_delim("~/PhD/Pédologie/Data/Raw/Bulk_density.csv",
                           delim = ";", escape_double = FALSE, trim_ws = TRUE)[,-(12:28)]


Drainage <- read_delim("~/PhD/Pédologie/Data/Raw/Drainage.csv",
