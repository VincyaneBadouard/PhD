...
# Table de granulo et densité apprente pour les calibrer les Tomst
...
write.csv(Pedo_data, "~/PhD/Microclimate/Tomst - data and scripts/Paracou_Tomst_humidity_granulo_parameters.csv")
```