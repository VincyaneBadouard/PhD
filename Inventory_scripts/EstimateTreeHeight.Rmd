...
Adults %>%
  ...
  geom_point(aes(col = "Crown height"), size = 0.2) + 
  geom_smooth(span = 0.75, linewidth = 0.8, aes(color = "Crown height")) +
  geom_point(data= Understory, size = 0.2, aes(color = "Crown height")) +
  geom_point(data= Understory, size = 0.2, aes(y = CrownBase, color = "Crown base")) +
  geom_smooth(data= Understory, span = 0.75, linewidth = 0.8, aes(y = CrownBase, color = "Crown base")) + 
