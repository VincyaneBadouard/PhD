...
Understory <- read_csv("~/PhD/Inventories/Data/Understory/Paracou/ALT_Paracou9ha_20240430.csv")
...
Understory <- Understory %>% left_join(strategy, by="ScientificName")
```
...
Understory %>% 
  ...
  theme_minimal() +
  labs(title="ALT Paracou P16 - Size distribution", x ="DBH (cm)", y = "Individuals number")

ggsave("ALT_Paracou_P16_9ha_Size_distribution.png", path = "D:/Mes Donnees/PhD/Figures/inventory", width = 20, height = 10, units = "cm", dpi=800, bg="white")
