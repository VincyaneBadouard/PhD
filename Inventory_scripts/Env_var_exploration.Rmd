...
ggsave("Paracou_P16_ALT_topolevels.png",
       path = "D:/Mes Donnees/PhD/Figures/Topography/",
...
ggplot() + 
  ...
  scale_fill_gradientn(name = "Elevation (m)",
                       ...
                       na.value="white") +
  geom_sf(data = sf::st_cast(TopoLevels, "LINESTRING")) +
  geom_sf(data = sf::st_cast(ALT, "LINESTRING")) +
  theme_classic() +
  theme(axis.text= element_text(size=10),
        legend.title= element_text(size=16), legend.text= element_text(size=16))

ggsave("Paracou_P16_ALT_DEM_topolevels.png",
       path = "D:/Mes Donnees/PhD/Figures/Topography/",
       width = 20, height = 15, units = "cm", dpi=800, bg="white")
...
ggsave("Paracou_P16_ALT_TWI_topolevels.png",
       path = "D:/Mes Donnees/PhD/Figures/Topography/",
       width = 20, height = 15, units = "cm", dpi=800, bg="white")
...
ggsave("Paracou_P16_ALT_HAND_topolevels.png",
       path = "D:/Mes Donnees/PhD/Figures/Topography/",
       width = 20, height = 15, units = "cm", dpi=800, bg="white")
```
...
ggsave("Elevation_VS_topolevels.png", path = "D:/Mes Donnees/PhD/Figures/Topography", width = 25, height = 15, units = "cm", dpi=800, bg="white")
...
ggsave("TWI_VS_topolevels.png", path = "D:/Mes Donnees/PhD/Figures/Topography", width = 25, height = 15, units = "cm", dpi=800, bg="white")
...
ggsave("HAND_VS_topolevels.png", path = "D:/Mes Donnees/PhD/Figures/Topography", width = 25, height = 15, units = "cm", dpi=800, bg="white")
...
ggsave("Elevation_VS_HAND.png", path = "D:/Mes Donnees/PhD/Figures/Topography", width = 25, height = 15, units = "cm", dpi=800, bg="white")
...
ggsave("HAND_VS_TWI.png", path = "D:/Mes Donnees/PhD/Figures/Topography", width = 25, height = 15, units = "cm", dpi=800, bg="white")
```
...
png("D:/Mes Donnees/PhD/Figures/Topography/Correlation_plot_topo.png",
