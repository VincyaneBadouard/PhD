...
```{r}
write.csv(LAI2200, "~/PhD/Inventories/Data/Piquets_ALT/XY_Stakes_Paracou.csv") # à mettre en vraies coordonnées UTM
```
...
1) Les 4 coins du carré de 1 ha sont eux normalement bien positionnés.  
