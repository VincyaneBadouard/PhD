...
```{r}
data <- Tomst # Tomst # LAI2200 # grid # ALT # Und
...
P16shp <- st_as_sf(vect("//amap-data.cirad.fr/work/users/VincyaneBadouard/Lidar/ALS2022/Shapefiles/Parcelles_Understory.shp"))
CHM <- terra::rast("D:/Mes Donnees/PhD/Lidar/ALS2023/Rasters/Paracou_P16_2023_4ha+50mbuffer_ALS_CHM_1mres.tif")
DSM <- terra::rast("D:/Mes Donnees/PhD/Lidar/ALS2023/Rasters/Paracou_P16_2023_4ha+50mbuffer_ALS_DSM_1mres.tif")

dataUTMsf <- st_as_sf(dataUTM, coords = c('Xutm','Yutm'))
dataUTMsf <- st_set_crs(dataUTMsf, st_crs(P16shp)) 
...
ggplot() +
  ...
  scale_fill_gradientn(name = "Canopy height (m)",
                       colors = lidR::height.colors(25), na.value="white") +
  geom_sf(data = sf::st_cast(P16shp, "LINESTRING"), col = "white") +
  geom_sf(data = dataUTMsf, col = "black", size = 0.25) +
  theme_classic() +
  ggtitle("Paracou P16 - sensors positions")

# ggsave("Paracou_P16_sensors_theoretical_UTM_positions_onCHM+50mbuffer.png",
#        path = "D:/Mes Donnees/PhD/Figures/Sensors",
#        width = 18, height = 17, units = "cm", dpi=800, bg="white")
...
```{r}
MNT <- terra::rast("D:/Mes Donnees/PhD/Lidar/ALS2023/Rasters/Paracou_P16_2023_4ha+50mbuffer_ALS_DEM_1mres.tif")

ggplot() +
  geom_spatraster(data = MNT, aes(fill = `Paracou_P16_2023_4ha+50mbuffer_ALS_DEM_1mres`)) +
  scale_fill_gradientn(name = "Elevation (m)",
                       colors = terrain.colors(30, rev=T),
                       na.value="white") +
...
# ggsave("Paracou_P16_sensors_theoretical_UTM_positions_onDEM+50mbuffer.png",
#        path = "D:/Mes Donnees/PhD/Figures/Sensors",
...
# write.csv(LAI2200UTMxyz, "//amap-data.cirad.fr/work/users/VincyaneBadouard/Lidar/ALS2023/Coordinates/LAI2200_theoretical_UTMxyz.csv")
write.csv(dataxyz, "//amap-data.cirad.fr/work/users/VincyaneBadouard/Lidar/ALS2023/Coordinates/Tomst_theoretical_UTMxyz.csv")
