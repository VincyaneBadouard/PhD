...
- transect Jérome : 20 (22 Tomst) capteurs espacés de *10m* : start =(390;110)  ; end = (390;300)
- transect BF : 5 capteurs espacés de *10m* : x = seq(450,500, by= 10) ; y = ?
- transect gap : 5 capteurs espacés de *10m* : y = 0 pour le 1er, 10 pour les autres ; x = ?

```{r}
HOBO_jerome <- data.frame(
  Sensor = "HOBO",
  Transect = "Jerome",
  Id = as.character(seq(1:20)), # S->N
  x = 390,
...
HOBO_BF <- data.frame(
  Sensor = "HOBO",
  Transect = "BF",
  Id = as.character(seq(21:25)), 
  x = c(450, seq(450,500, by= 10)),
  y = seq(,, by= 10)
)
nrow(LAI2200_HOBO)==20
