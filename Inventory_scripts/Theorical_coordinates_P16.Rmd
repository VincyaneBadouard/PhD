...
```{r}
data <- Und # Tomst # LAI2200 # grid # ALT # Und
...
ggplot() +
  ...
  geom_sf(data = dataUTMsf, col = "red", size = 0.4) +
  ggtitle("Paracou P16 - Tomst sensors positions")

# ggsave("Paracou_P16_Tomst_sensors_theoretical_UTM_positions.png",
#          path = "D:/Mes Donnees/PhD/Figures/Sensors",
#          width = 15, height = 15, units = "cm", dpi=800, bg="white")
...
# write.csv(datalocal, "//amap-data.cirad.fr/work/users/VincyaneBadouard/Lidar/ALS2023/Coordinates/Grid_4ha_10x10m_each5mZ_local.csv")

# write.csv(datalocal, "//amap-data.cirad.fr/work/users/VincyaneBadouard/Lidar/ALS2023/Grid_4ha_10x10m_each1mZ_local.csv")
# write.csv(LAI2200local, "//amap-data.cirad.fr/work/users/VincyaneBadouard/Lidar/ALS2023/LAI2200_theoretical_local.csv")
# write.csv(datalocal, "//amap-data.cirad.fr/work/users/VincyaneBadouard/Lidar/ALS2023/Tomst_theoretical_local.csv")
