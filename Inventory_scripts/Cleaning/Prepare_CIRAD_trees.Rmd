...
(nrow(spSelection)/nrow(AdultsP16))*100 # les sp selectionnées représentent 78% du jeu de données
length(unique(spSelection$ScientificName)) # 64 selected species
