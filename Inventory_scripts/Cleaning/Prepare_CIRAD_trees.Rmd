...
# My filters
**faudra que ce soit le memes espèces que celles choisies dans ALT**
```{r}
...
```{r}
nrow(AdultsP16) - nrow(AdultsP16_filtred) # 3959
length(unique(AdultsP16$ScientificName)) - length(unique(AdultsP16_filtred$ScientificName)) # 394 species lost, 64 sp kept
