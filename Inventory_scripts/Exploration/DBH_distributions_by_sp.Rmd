...
Inventory <- read_csv(
    "D:/Mes Donnees/PhD/Inventories/Data/Understory/Paracou/P16_Paracou_InvandEnv.csv"
...
pdf("//amap-data.cirad.fr/work/users/VincyaneBadouard/Inventories/Explo_plots/DBH_distributions_by_species.pdf",
    , width = 15, height = 10)
