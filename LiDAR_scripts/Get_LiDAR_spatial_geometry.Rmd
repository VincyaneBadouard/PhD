...
### Check that we retreive the original point for emission point, direction vector and distance:
...
# Check that we retreive the original point from emission point, direction vector and distance:
...
# Test_contCloud[100:200, c("XB100", "YB100", "ZB100") := NA_real_] # 100 points
# 
...
all(Z0 - vector_coord$Z0[removed] == 0) # the emission coordinates are well retreived!
...
projeter les points sans écho originellment en dehors de la zone d'étude (à 500 m par ex) et enregistrer ces points sous un nouveau laz

soit compléter le laz existant soit faire un laz à part et combinder avec lidr