...
LASrun <- LAStool('lassplit64', inFiles, # input
                  '-cores', cores,
                  '-by_gps_time_interval 60', # parameter
...
lof <- dir("//amap-data.cirad.fr/work/users/VincyaneBadouard/Lidar/HovermapUAV2023/P16_C19C20/FullDens_split", full.names=T) # list files in the named directory Z:/users/VincyaneBadouard
