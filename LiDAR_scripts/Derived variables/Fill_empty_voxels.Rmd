...
un peu long
```{r}
na <- nrow(fullcanopy@data[nbSampling < 4])/nrow(fullcanopy@data) # proportion of voxels below sampling threshold level (à garder pour comparer entre les différentes méthodes d'acquisition lidar)
write.csv(na, )
...
sum(is.na(fullcanopy@data$HLE)) # 1888
