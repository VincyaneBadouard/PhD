...
ggplot(dataLow, aes(x= ground_distance_disc, y= `%_empty_voxels`)) +
  ...
  scale_colour_manual(values = c("High altitude" = "darkgreen",
                                 "Low altitude" = "green")) +
  ggtitle("P16 - 2023 - 4ha + buffer - Proportion of empty voxels per altitude") +
  labs(y="% of empty voxels", x="Ground distance", color = "LiDAR acquisition") +
  coord_flip() +
  xlim(0,45)
