...
range(laz_GroundClassif$Z)
range(laz_GroundClassif@data[Classification == 2,]$Z) # Points sol: 6.3823 36.5808! (attendu : (Z>(-0.2) & Z< 0.5))
range(laz_GroundClassif@data[Classification == 1,]$Z) # Points vegetation: 6.5425 65.9298
```
