...
```{r}
ROI <- st_as_sf(vect("Y:/users/VincyaneBadouard/Lidar/ALS2022/Parcelles_Understory.shp")) # 4 carrés
...
```{r}
writeLAS(ALS_C14C15, "Y:/users/VincyaneBadouard/Lidar/ALS2023/HighAltitudeFlight/P16_2023_HighAlt_C14C15.laz")
writeLAS(ALS_C19C20, "Y:/users/VincyaneBadouard/Lidar/ALS2023/HighAltitudeFlight/P16_2023_HighAlt_C19C20.laz")
```
...
```{r}
zone <- st_as_sf(vect("Y:/users/VincyaneBadouard/Lidar/ALS2022/Parcelles_Understory.shp")) # 4 carrés

traj_14_15 <- st_set_crs(st_as_sf(unique(
  fread("Y:/users/VincyaneBadouard/Lidar/HovermapUAV2023/Translation/Traj/UAV_C14C15_traj_translated.xyz"
  )[,list(X,Y,Z)]), coords = c('X','Y')), crs(zone))
traj_19_20 <- st_set_crs(st_as_sf(unique(
  fread("Y:/users/VincyaneBadouard/Lidar/HovermapUAV2023/Translation/Traj/UAV_C19C20_traj_translated.xyz"
  )[,list(X,Y,Z)]), coords = c('X','Y')), crs(zone))
```
...
laz_14_15 <- ComputeScanAngle(laz_14_15, traj_14_15)
laz_19_20 <- ComputeScanAngle(laz_14_15, traj_19_20)
