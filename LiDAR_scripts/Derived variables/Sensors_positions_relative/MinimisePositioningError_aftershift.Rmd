...
quantile(comp$MeanTransmittance_LowInt1m_init - comp$MeanTransmittance_LowInt1m_best, .95) # 0.007983491; aftershift : 0.006590541. Res 1m : 0.03464978
quantile(comp$MeanTransmittance_LowInt1m_init - comp$MeanTransmittance_LowInt1m_best, .05) # -0.0634546; aftershift : -0.01607339. Res 1m : -0.02661183  
...
ggplot() +
  geom_sf(data= init_sf, aes(col = "Initial"), size = 1) + 
  geom_sf(data= best_sf, aes(col = "Optimised"), size = 1) + 
  scale_colour_manual(values = c("Initial" = "red", 
                                 "Optimised" = "forestgreen"),
                      breaks=c("Initial", "Optimised")) +
  theme(title=element_blank(),  axis.text=element_text(size=6),
        legend.title=element_blank(), legend.text=element_text(size=14))

ggsave("P16_2023_4ha_Init_and_optimisedcoordinates_simulations_optR12_Ring.png",
       path = "D:/Mes Donnees/PhD/Figures/lidar/Coordinates_simulations",
       width = 20, height = 20, units = "cm", dpi=800, bg="white")
```
