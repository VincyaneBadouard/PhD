...
dataLow %>% 
  ...
  scale_colour_manual(values = c("High altitude" = "blue",
                                 "Low altitude" = "#56B4E9")) +
  theme_minimal() +
  ggtitle("P16-2023-4ha+buffer - PAD profile before estimation (intensity)- res 2m") +
...
ggsave("ALS2023_P16_4ha_HighvsLow_PAD_before_fillEmptyVxl_intensity_2m.png",
...
scale_colour_manual(values = c("High altitude (pulse min=20)" = "blue",
                               "Low altitude (pulse min=20)" = "#56B4E9"
...
breaks=c("High altitude (pulse min=20)",
  ...
  ggtitle("P16-2023-4ha+buffer - PAD profile after estimation (intensity) res 2m") +
...
ggsave("ALS2023_P16_4ha_HighvsLow_PAD_after_fillEmptyVxl_intensity_2m.png",
       path = "D:/Mes Donnees/PhD/Figures/lidar/Voxélisation/PAD_profil/Intensity_2m",
       width = 18, height = 20, units = "cm", dpi=800, bg="white")
```
...
dataLow %>% 
  ...
  scale_y_continuous(breaks = seq(0, max(dataHigh$MeanNbsampling), by=100))+
  coord_flip() #+
...
ggsave("ALS2023_P16_4ha_HighvsLow_nbSampling_mean_intensity_2m.png",
