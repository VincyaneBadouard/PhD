...
mean(label$MeanTransmittance_HighInt1m_mean-label$MeanTransmittance_LAI2200_mean)/measuredTranmittance_mean
mean(label$MeanTransmittance_LowInt1m_mean-label$MeanTransmittance_LAI2200_mean)/measuredTranmittance_mean
mean(label$MeanTransmittance_UAVInt1m_mean-label$MeanTransmittance_LAI2200_mean)/measuredTranmittance_mean
