...
for(t in c("HOBO", "LAY")){
  ...
  print(
    LAI2200_LiDAR %>% 
      ...
      geom_line(aes(y = MeanTransmittance_High, colour = "High altitude")) +
      geom_errorbar(aes(ymin=MeanTransmittance_High-SdTransmittance_High,
                        ymax=MeanTransmittance_High+SdTransmittance_High, colour = "High altitude"), width=.2) +
      
      geom_point(aes(y = MeanTransmittance_Low, colour = "Low altitude")) +
      geom_line(aes(y = MeanTransmittance_Low, colour = "Low altitude")) +
      geom_errorbar(aes(ymin=MeanTransmittance_Low-SdTransmittance_Low,
                        ymax=MeanTransmittance_Low+SdTransmittance_Low, colour = "Low altitude"), width=.2) +
      
      geom_point(aes(y = MeanTransmittance_LAI2200, colour = "LAI2200")) +
      geom_line(aes(y = MeanTransmittance_LAI2200, colour = "LAI2200")) +
      geom_errorbar(aes(ymin=MeanTransmittance_LAI2200-SdTransmittance_LAI2200,
                        ymax=MeanTransmittance_LAI2200+SdTransmittance_LAI2200, colour = "LAI2200"), width=.2) +
