...
label <- data.frame(
  ...
  Ring = 4, 
  MeanTransmittance_LAI2200_mean = c(0.079, 0.075, 0.071), 
...
print(
  LAI2200_LiDAR_transect %>% 
    ...
    theme(legend.position="bottom",legend.title= element_blank(), strip.text = element_text(size=18), axis.title= element_text(size=15), axis.text= element_text(size=15), legend.text= element_text(size=18))
)
...
ggsave("P16_2023_4ha_Long_profile_allrings_facet_Intensity1m.png",
       path = "D:/Mes Donnees/PhD/Figures/lidar/Correlations/Long_profile/Intensity_1m/DZ_cor",
       width = 40, height = 20, units = "cm", dpi=800, bg="white")
