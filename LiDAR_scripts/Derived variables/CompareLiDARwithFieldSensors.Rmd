...
ggplot(DZ, aes(x = ID, y= Transmittance, col = azimut)) +
  geom_point() +
  # theme_minimal() +
  scale_colour_gradient2(name = "Azimut", low="grey", high="grey", mid = "red", midpoint = 0) +
  facet_grid(vars(as.factor(ring)), scales = "free")

ggsave("DZ_transmittances.png",
...
hist(DZ$Transmittance)
hist(LiDAR$MeanTransmittance)
