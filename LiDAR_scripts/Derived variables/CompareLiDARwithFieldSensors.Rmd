...
ggsave(paste("Long_profile_The2_transects_MeanStandardErrorTransmittance_of_the_transect_byRing_Intensity1m_only.png", sep=""),
       path = "D:/Mes Donnees/PhD/Figures/lidar/Correlations/Long_profile/Intensity_1m",
       width = 25, height = 20, units = "cm", dpi=800, bg="white")
...
for(t in c("HOBO", "LAY")){
  ...
  ggsave(paste("Long_profile_",t," transect","_MeanStandardErrorTransmittance_of_the_transect_byRing_Intensity1m_only.png", sep=""),
         path = "D:/Mes Donnees/PhD/Figures/lidar/Correlations/Long_profile/Intensity_1m",
         width = 25, height = 20, units = "cm", dpi=800, bg="white")
}
```
...
CorMatrix <- round(CorMatrixS$r, digits = 2)[,1:5]  # matrice de corrélation
Pval_corr <- CorMatrixS$P # p-values

write.csv(CorMatrix, "D:/Mes Donnees/PhD/Figures/lidar/Correlations/Correlations/Intensity_1m/Correlation_plot_LiDAR_ALS_UAV_vs_LAI2200.csv")

# Plot de la matrice de corrélation :
png("D:/Mes Donnees/PhD/Figures/lidar/Correlations/Correlations/Intensity_1m/Correlation_plot_LiDAR_ALS_UAV_vs_LAI2200_vert.png",
...
HOBO %>% 
  ...
  geom_linerange(aes(ymin=HOBO_Light_annual_mean-HOBO_Light_annual_se,
                     ymax=HOBO_Light_annual_mean+HOBO_Light_annual_se)) + # ,  color = "Standard error"
  
  geom_linerange(aes(ymin=HOBO_Light_annual_mean-HOBO_Light_annual_se,
                     ymax=HOBO_Light_annual_mean+HOBO_Light_annual_se)) +
  geom_point(aes(y = HOBO_Light_annual_mean)) + # , colour = "Annual"
  geom_line(aes(y = HOBO_Light_annual_mean)) +
...
# scale_colour_manual(values = c("Annual" = "#CC79A7",
#                                # "Wet season" = "#0072B2",
#                                # "Dry season" = "#999999",
#                                # "October" = "#D55E00",
#                                "Standard error"= "#666666"),
...
labs(title = "HOBO sensors light", y="Average annual light (lux)", x="Sensors ID", color = "Period") +
  scale_x_continuous(breaks = seq(1:idmax)) + # 26 # 20
