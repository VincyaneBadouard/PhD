...
idstem ou idtree pour light ? peut importe on n'a plus que la 1ère tige après avoir sommer les BA et estimer la hauteur de la 1ère tige; et si na ? pas censé

(avec le High alt pcq meilleur couverture des lignes de vol)
```{r}
...
# laz pour 25 ha high alt intensity : !! "Y:\users\VincyaneBadouard\Lidar\ALS2023\HighAltitudeFlight\ForTrees\Vox\P16_2023_HighAlt_25ha_buffer_intensity1m_testnewEB.vox"
