...
# Install AMAPVox
V2.2 : //amap-data.cirad.fr/work/users/PhilippeVerley/amapvox/nightly-build/AMAPVox-2.2.0-windows
```{r}
...
ST <- readLAScatalog( # # las catalog. filter only 1st returns
    # folder = "//amap-data.cirad.fr/safe/lidar/ALS/Paracou/2023/Laz", filter = "keep"
    
    folder = "//amap-data.cirad.fr/safe/DATAverse_tempo/ALSPar2019/laz", filter = "keep"

  # folder = "//amap-data.cirad.fr/safe/lidar/ALS/Paracou/2023/LazClassifiedWithExtraByte", filter = "keep"
    # folder = "D:/Mes Donnees/PhD/Lidar/ALS2023/HighAlt/", filter = "keep"
  # folder = "D:/Mes Donnees/PhD/Lidar/ALS2023/HighAlt/", filter = "keep"
  ) 
...
ROI <- vect("//amap-data.cirad.fr/work/users/VincyaneBadouard/Lidar/ALS2023/Shapefiles/Plot16_25ha_buffer.shp") # interest zone + 100m buffer
plot(ROI)
...
writeLAS(PC,
         "//amap-data.cirad.fr/work/users/VincyaneBadouard/Lidar/ALS2019/Raw_laz/P16_2019_25ha_buffer_raw.laz"
         # "//amap-data.cirad.fr/work/users/VincyaneBadouard/Lidar/ALS2023/HighAltitudeFlight/Raw_laz/P16_2023_25ha_HighAlt_buffer_raw_withoutextrabytes.laz"
)
...
mnt <- rast(
  ...
  # "//amap-data.cirad.fr/work/users/VincyaneBadouard/Lidar/ALS2023/LowAltitudeFlight/MNT/dtm2023_LowAlt.tif"
    ...
    "//amap-data.cirad.fr/work/users/VincyaneBadouard/Lidar/ALS2019/Raster/DTM_Paracou_2019_50cm.tif"

)
terra::crs(mnt) <- terra::crs("EPSG:2972")

ggplot() + 
  geom_spatraster(data = mnt, aes(fill = MNT50cm_Par2019)) + # mnt_roi36ha_1m # dtm2023 ; MNT_0.5m_IRD_500m_Paracou_284000_579500
...
# plot(mntROI)
ggplot() + 
  geom_spatraster(data = mntROI, aes(fill = MNT50cm_Par2019)) + # mnt_roi36ha_1m # dtm2023 ; MNT_0.5m_IRD_500m_Paracou_284000_579500
  scale_fill_gradientn(name = "Elevation (m)",
                       colors = terrain.colors(30, rev=T),
                       na.value="white") +
  theme_classic() +
...
ggsave("P16_25ha_buffer_DEM.png",
  # paste(file, "_DEM_1m_crop.png", sep = "" ),
       # path = "D:/Mes Donnees/PhD/Figures/lidar/UAV",
       path = "D:/Mes Donnees/PhD/Figures/lidar/MNT",
       width = 25, height = 15, units = "cm", dpi=800, bg="white")

writeRaster(raster(mntROI),
            # "//amap-data.cirad.fr/work/users/VincyaneBadouard/Lidar/ALS2023/LowAltitudeFlight/MNT/dtm2023_LowAlt_25ha_buffer.asc",
            # "//amap-data.cirad.fr/work/users/VincyaneBadouard/Lidar/ALS2023/HighAltitudeFlight/MNT/dtm2023_HighAlt_25ha_buffer.asc",
...
```{r}
table(PC@data$NumberOfReturns) # 14 echos ALS 2023 LowAlt; 12 HighAlt ; UAV : 4 ; 2019 : 7
PC@data
...
```{r}
mntROI <- rast(
"//amap-data.cirad.fr/work/users/VincyaneBadouard/Lidar/ALS2023/HighAltitudeFlight/MNT/dtm2023_25ha_HighAlt_buffer.asc")
...
range(PC@data$Intensity) #  0 46071
names(PC@data)
...
ratio <- means[Classification==2,]$mean/means[Classification==3 | Classification==4,]$mean # ratio sol/veg reflectance 

ratio ==0 | is.null(ratio)
...
# PC <- readLAS("//amap-data.cirad.fr/work/users/VincyaneBadouard/Lidar/ALS2023/LowAltitudeFlight/LAZ/P16_2023_25ha_LowAlt_buffer_intensitycor.laz")
# range(PC@data$Intensity) # 0-40
...
writeLAS(PC,
         ...
         # "//amap-data.cirad.fr/work/users/VincyaneBadouard/Lidar/ALS2023/HighAltitudeFlight/LAZ/P16_2023_25ha_HighAlt_buffer_withoutextrabytes.laz"
         ...
         "//amap-data.cirad.fr/work/users/VincyaneBadouard/Lidar/ALS2019/LAZ/P16_2019_25ha_buffer50m_intensitycor.laz"
...
xmlfile <- "//amap-data.cirad.fr/work/users/VincyaneBadouard/Lidar/ALS2023/HighAltitudeFlight/ForTrees/P16_2023_25ha_buffer_HighAlt_Vox_equalecho1m"
