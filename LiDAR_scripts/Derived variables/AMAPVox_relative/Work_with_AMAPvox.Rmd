...
```{r}
# Si en dalles :
ST <- readLAScatalog(folder = "D:/Mes Donnees/PhD/Lidar/ALS2023/LowAlt/", filter = "keep") # las catalog. filter only 1st returns
...
writeLAS(PC,
         ...
         "//amap-data.cirad.fr/work/users/VincyaneBadouard/Lidar/ALS2023/LowAltitudeFlight/LAZ/P16_2023_25ha_LowAlt_buffer_intensitycor.laz"
