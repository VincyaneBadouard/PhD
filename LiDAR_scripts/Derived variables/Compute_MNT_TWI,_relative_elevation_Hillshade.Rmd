...
plotRaster <- function(raster, res){
  ...
  ggsave(paste("P16_2023_4ha_ALS_", deparse(substitute(raster)), "_",res,"m.png", sep=""),
...
```
```{r}
writeRaster(CHM, "D:/Mes Donnees/PhD/Lidar/ALS2023/Rasters/Paracou_P16_2023_4ha_ALS_CHM.tif")
writeRaster(DSM, "D:/Mes Donnees/PhD/Lidar/ALS2023/Rasters/Paracou_P16_2023_4ha_ALS_DSM.tif")
```
