...
hist(laz_scanAngles@data$ScanAngleRank) # 0 - 99
...
range(laz_GroundClassif$Z) # 4.783 63.437
range(laz_GroundClassif@data[Classification == 2L,]$Z) # Points sol: 4.783 37.96
range(laz_GroundClassif@data[Classification == 1L,]$Z) # Points vegetation: 5.073 63.437
...
ROI <- terra::vect(paste(root,"users/VincyaneBadouard/Lidar/ALS2023/Plot16_4ha_buffer.shp", sep = "")) # interest zone + 100m buffer
