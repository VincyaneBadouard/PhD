...
# Si 1 fichier
ST <- readLAS("//amap-data.cirad.fr/work/users/VincyaneBadouard/Lidar/ALS2023/P16_bbx_buf100m.laz")
...
PCall <- rbind(PC[[1]], PC[[2]])
PCall <- rbind(PCall, PC[[3]])
PCall <- rbind(PCall, PC[[4]])
...
writeLAS(PC, "//amap-data.cirad.fr/work/users/VincyaneBadouard/Lidar/ALS2023/P16_2023_4ha_buffer.laz")
