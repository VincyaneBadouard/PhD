...
write.csv(ClearnessIndex, "Z:/users/VincyaneBadouard/Lidar/ALS2023/ClearnessIndex.csv")
```
...
VOP <- as.matrix(read.table("Z:/users/VincyaneBadouard/Lidar/ALS2023/AMAPvox/VOP_P16_9ha.txt"))
