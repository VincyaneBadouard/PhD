...
Light <- Light[, !c("V5", "Z"), with = FALSE] # c'est quoi Z ?

# Remove edges
Light <- Light[X<90 & X> -90 & Y<90 & Y> -90]
# Plot
levelplot(`Period 1`~X*Y, data = Light) 
...
ggplot() + 
  ...
  scale_fill_gradientn(name = "Light intensity (transmittance)",
                       ...
                       na.value="white") +
  ggtitle("Light map") +  # where ?
  coord_sf()

# Greg dit qu'on peut retrouver les cooordonnées UTM avec la VOP
```
