...
```
```{r}
ALT <- st_read("D:/Mes Donnees/PhD/R_codes/PhD/test/ALT.shp")
ALT$geometry # xmin: 285305.8 ymin: 581256.6 xmax: 285680 ymax: 581629.8
min(ALT$geometry)
```
...
# Tr c'est la VOP
write.table(Tr,"Z:/users/LisaMoreno/Light/VOPPlotP16_4ha.txt",
...
# Tr c'est la VOP
write.table(Tr,"Z:/users/LisaMoreno/Light/VOPPlotNou_4ha.txt", 
            row.names = F, col.names = F)
```
