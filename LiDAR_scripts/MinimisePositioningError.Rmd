...
for(t in c("HOBO", "LAY")){
  for(R in 1:5){
    ...
    ggsave(paste("P16_2023_4ha_Long_profile_",t,"_transect_Ring",R,"_se_LowAlt_Intensity2m_Coordoptim.png", sep=""),
...
```{r}
vars <- c("MeanTransmittance_LowInt2m_init", "MeanTransmittance_LowInt2m_best", "MeanTransmittance_LAI2200")
...
ggsave(paste("Long_profile_The2_transects_MeanStandardErrorTransmittance_of_the_transect_byRing_LowAlt_Intensity2m_Coordoptim.png", sep=""),
       path = "D:/Mes Donnees/PhD/Figures/lidar/Correlations/Coord_optimised",
       width = 25, height = 20, units = "cm", dpi=800, bg="white")
...
for(t in c("HOBO", "LAY")){
  ...
  ggsave(paste("Long_profile_",t," transect","_MeanStandardErrorTransmittance_of_the_transect_byRing_LowAlt_Intensity2m_Coordoptim.png", sep=""),
         path = "D:/Mes Donnees/PhD/Figures/lidar/Correlations/Coord_optimised",
         width = 25, height = 20, units = "cm", dpi=800, bg="white")
}
```
