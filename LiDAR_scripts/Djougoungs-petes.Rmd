...
# Write
writeLAS(PC, "Z:/users/VincyaneBadouard/Lidar/ALS2022/P13_2022.laz")

# Read
# PC <- lidR::readLAS(files = "Z:/users/VincyaneBadouard/Lidar/ALS2022/P13_2022.laz")
...
In_Djougoungs <- mask(mnt, Djougoung_P13)
plot(In_Djougoungs)
