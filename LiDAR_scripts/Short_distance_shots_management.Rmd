...
Au préalable :
- décimer le ndp dans les zones de fortes densité (2.5 cm),
- dont le range est supérieur à 1.5m pour exclure l’opérateur mobile
- ne charger que les coordonnées et les points
...
ndp_clutter <- readLAS(
  "Z:/users/VincyaneBadouard/Lidar/Hovermap/Scans Hovermap ST-X/Escadrone180723_ss_filtre/local/out3_decim2.5cm_range1.5.laz",
  select = "xyz")
plot(ndp_clutter)
ndp <- ndp_clutter
rm(ndp_clutter)
