...
Gaps_vect_coord <- trace_shots_without_echo(ST, Traj, vector_coord, SampleTime = 3, OneRing = TRUE, frot = 20)

# pq tirs vides dans le plafond 

```

# Partie 3 - Projeter un nuage de points (B) d'après ces vecteurs dans la zone de cécité tous les 5 cm
