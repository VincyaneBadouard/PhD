...
```{r}
library(lattice) # pour plotter la carte de lumière
Light <- fread("Z:/users/VincyaneBadouard/Lidar/ALS2022/lightMap_1mAGL_2by2.txt", skip=10, nrows = 20403)
# enlever les 2 lignes mean
# Light <- Light[Y != "MEAN"]

levelplot(`Period 1`~X*Y, data=Light[X<90 & X> -90 & Y<90 & Y> -90 ])
```



Faux tirs manquants à faible distance faire un script au cours de juillet
