...
If low, measurement are sufficient and we can take the mean or the average for each location.  
...
data[data$File_Id=="P16LAY2",]$Id # P16HOBO5

# To check the Id
data %>% 
  filter(File_Id == "P16LAY2") %>% # P16HOBO1
