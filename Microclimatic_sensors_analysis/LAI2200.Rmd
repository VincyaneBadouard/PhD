...
# Moyenner les transmittances par location
```{r}
...
write.csv(mean, "D:/Mes Donnees/PhD/Light/LAI-2200/LAI2200_data_P16HOBO_nocalib_mean.csv")
```

# Add environment data
```{r}
mean <- read_csv("~/PhD/Light/LAI-2200/LAI2200_data_P16HOBO_mean.csv")

# For LAY
LAYenv <- read_delim("~/PhD/Light/LAI-2200/LAI2200_environment.csv", 
...
ggplot(mean, aes(x = Id, y = Transmittance_mean, col = Environment)) + 
  geom_point() +
  facet_grid(vars(Ring), scales = "free")
...
ggplot(mean, aes(x = Id, y = Transmittance_mean, col = LightHabitat)) + 
  geom_point() +
  facet_grid(vars(Ring), scales = "free")
```
