...
# To check the Id
data %>% 
  filter(File_Id == "P16HOBO1") %>% # P16HOBO1
...
sink("D:/Mes Donnees/PhD/Light/LAI-2200/DATA/Transmittance_P16HOBO_cor_byId.txt") # path
...
# Write Transmittances correlation in text file
sink("D:/Mes Donnees/PhD/Light/LAI-2200/DATA/Transmittance_P16HOBO_cor_byRing.txt") # path
By
sink() # close the external connection
...
write.csv(Transmittance_data, "D:/Mes Donnees/PhD/Light/LAI-2200/DATA/LAI2200_data_P16HOBO_mean.csv")
```
