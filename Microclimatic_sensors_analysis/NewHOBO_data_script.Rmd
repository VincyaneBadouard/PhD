...
TourAFlux_2023_2024 <- TourAFlux_2023_2024 %>% 
  ...
  mutate(Hour =  format(Date_Time, format = "%H:%M:%S")) %>% 
...
TourAFlux_2023_2024 %>% 
  filter(Rg > 0) %>%
  ggplot(aes(x = Month,y = CNR4_SW_up_Avg)) + # CNR4_SW_up_Avg
  geom_boxplot(aes(color = Season)) +
...
ggplot(TourAFlux_2023_2024, aes(x = Hour,y = Rg)) +
  geom_line() +
